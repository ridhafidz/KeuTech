...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool _isPasswordVisible = false; // Default false (tersembunyi)
              ...
              Align(
                ...
                child: TextButton(
                  ...
                  child: Text('Lupa password?',
                      style: bodyTextStyle.copyWith(color: kPrimaryColor)),
                ),
              ),
              const SizedBox(height: 20),
  ...
  Widget _buildInputField(
    ...
    return TextFormField(
      ...
      // Menggunakan state _isPasswordVisible untuk toggle obscureText
      ...
      decoration: InputDecoration(
        ...
        // Ikon mata hanya muncul jika ini field password
        suffixIcon: isPassword
            ? IconButton(
                icon: Icon(
                    // Ganti ikon berdasarkan state visibility
                    _isPasswordVisible
                        ? Icons.visibility
                        : Icons.visibility_off,
                    color: Colors.grey),
                onPressed: () {
                  // Toggle state saat ikon ditekan
                  setState(() {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: _isLoading
              ? null
              : _signIn, // Panggil _signIn atau nonaktifkan saat loading
          borderRadius: BorderRadius.circular(15),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
